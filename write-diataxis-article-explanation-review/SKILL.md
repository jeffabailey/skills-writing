...
1. Check if `~/.claude/cache/writing-prompts/diataxis-article-explanation-review.md` exists
...
2. **Load the review prompt** -- Load the Diátaxis Explanation Review prompt (slug: `diataxis-article-explanation-review`) using the caching steps above.
