...
1. Check if `~/.claude/cache/writing-prompts/classical-rhetoric-article-create.md` exists
...
2. **Load the prompt** -- Load the Classical Rhetoric Article Create prompt (slug: `classical-rhetoric-article-create`) using the caching steps above.
